...
var Ticketek = require('./concert.js').Ticketek;
...
var SampleApp = function() {
    ...
    self.createRoutes = function() {
        ...
        self.routes['/concerto/:evento'] = function(req, res){
        ...
        self.routes['/concert'] = function(req, res) {
          if (resp != undefined && resp.conciertos != undefined){
            resp.cantidad = 0;
            resp.conciertos = [];
          }
          miRequest = res;
          request({ uri: url}, onCompleteLoad);
        };
